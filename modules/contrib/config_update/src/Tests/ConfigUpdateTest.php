...
class ConfigUpdateTest extends WebTestBase {
  ...
  public function testConfigReport() {
    ...
    $this->assertReport('Search page', array(), array(), array());
    ...
    $this->assertReport('Search module', array(), array(), array(), array('added'));
    $this->drupalGet('admin/config/development/configuration/report/theme/classy');
    $this->assertReport('Classy theme', array(), array(), array(), array('added'));
    // The Testing profile also has an problem currently in the Missing section.
    $this->drupalGet('admin/config/development/configuration/report/profile');
    $this->assertReport('Testing profile', array(), array(), array(), array('missing', 'added'));
    ...
    $missing = array('search.page.user_search' => 'Users');
    $this->drupalGet('admin/config/development/configuration/report/type/search_page');
    $this->assertReport('Search page', $missing, array(), array());
    $this->drupalGet('admin/config/development/configuration/report/module/user');
    $this->assertReport('User module', $missing, array(), array(), array('added', 'changed'));
    ...
    $this->drupalGet('admin/config/development/configuration/report/type/search_page');
    $this->assertReport('Search page', array(), array(), $changed);
    ...
    $this->assertReport('Search page', array(), $added, array());
    ...
    $this->drupalGet('admin/config/development/configuration/report/module/search');
    $this->assertReport('Search module', array(), array(), $changed, array('added'));
   ...
   */
  protected function assertReport($title, $missing, $added, $changed, $skip = array()) {
